...
class OtpVerifyWebUiView extends StatelessWidget {

  const OtpVerifyWebUiView({super.key});
              ...
              child: Column(
                ...
                children: [
                  Align(
                    ...
                    child: GradientText(AppStaticText.otpVerification.tr,
                        style: AppTextStyle.appTextStyle(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        controller.countdown > 0 ? controller.formattedTime : AppStaticText.otpExpired.tr,
                        style: AppTextStyle.appTextStyle(
                  ...
                  const Gap(24),
                  controller.isLoading ? const CustomLoadingButton() : CustomButton(
                      onPressed: (){
