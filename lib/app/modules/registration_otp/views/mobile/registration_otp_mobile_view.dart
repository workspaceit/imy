...
class RegistrationOtpMobileView extends StatelessWidget {

  const RegistrationOtpMobileView({super.key});
      ...
      child: GetBuilder<RegistrationOtpController>(
          builder: (controller) => Scaffold(
            ...
            appBar: AppBar(
              ...
              backgroundColor: AppColors.colorWhite,
              leading: IconButton(
                  onPressed: () => Get.offAndToNamed(Routes.FACE_VERIFICATION),
                ...
                bottomNavChild: Column(
                  ...
                  children: [
                    ...
                    controller.isSubmit ? const CustomLoadingButton() : CustomButton(
                      onPressed: () {
                        controller.rememberMe ? controller.matchVerificationCode() : AppUtils.errorToastMessage("You don't accept terms & conditions");
                      },
