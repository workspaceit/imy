...
class WithdrawHistoryMobileView extends StatelessWidget {
  const WithdrawHistoryMobileView({super.key});
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, index) => Row(
                      ...
                      children: [
                        ...
                        controller.withdrawHistoryList[index].status == "pending" ? const SizedBox() : GestureDetector(
