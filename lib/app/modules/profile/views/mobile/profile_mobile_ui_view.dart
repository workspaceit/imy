...
class ProfileMobileUiView extends StatelessWidget {
  const ProfileMobileUiView({super.key});
    ...
    return SafeArea(
      ...
      child: GetBuilder<ProfileController>(builder: (controller) {
        return Scaffold(
                    ...
                    builder: (context) => CustomDialog(
                      ...
                      dialogChild: Column(
                        ...
                        children: [
                              ...
                              CustomButton(
                                  onPressed: () {
                                    // final apiService = ApiServiceInterceptor(sharedPreferences: Get.find());
                                    // apiService.sharedPreferences.remove(LocalStorageHelper.accessTokenKey);
                                    // Get.offAllNamed(Routes.LOGIN);
                                    // AppUtils.successToastMessage("Logout Successfully.");
          ...
          bottomNavigationBar: const MainBottomNav(currentScreen: 4),
        );
      }),
    );
  }
