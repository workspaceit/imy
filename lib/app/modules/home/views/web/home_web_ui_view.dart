...
class HomeWebUiView extends StatelessWidget {
  final ScrollController scrollController;
  const HomeWebUiView({required this.scrollController, super.key});
    ...
    return SafeArea(
      ...
      child: GetBuilder<HomeController>(builder: (controller) {
        return Scaffold(
            ...
            children: [
              ...
              Flexible(
                child: SingleChildScrollView(
                  ...
                  padding: const EdgeInsetsDirectional.only(start: 24, bottom: 20, end: 24),
                  child: Align(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                                              ...
                                              child: SingleChildScrollView(
                                                ...
                                                Column(
                                                  ...
                                                  children: List.generate(
                                                    countryList.length, (index) => InkWell(
                                                    borderRadius: BorderRadius.circular(12),
                                                    onTap: (){
                          ...
                          controller.isFilterLoading ? const Padding(
                            ...
                            children: List.generate(controller.userDataList.length, (index) {
                              if (index == controller.userDataList.length) {
                                return controller.hasNext() ? const Padding(
                          ...
                          const Gap(12),
                          controller.userDataList.length < 20 || controller.page == controller.totalPage ? const SizedBox() : Align(
                            alignment: Alignment.center,
                            child: InkWell(
                              hoverColor: AppColors.colorRedB,
                              borderRadius: BorderRadius.circular(8),
          ...
          /// -------------------- bottom navigation ----------------------------
          bottomNavigationBar: const MainBottomNav(currentScreen: 0, isWeb: true),
        );
      }),
    );
  }
