...
class AccountSettingsMobileUiView extends StatefulWidget {

  const AccountSettingsMobileUiView({super.key});

  @override
  State<AccountSettingsMobileUiView> createState() => _AccountSettingsMobileUiViewState();
}

class _AccountSettingsMobileUiViewState extends State<AccountSettingsMobileUiView> {
