...
class ChatMobileView extends StatefulWidget {
  const ChatMobileView({super.key});
  @override
  State<ChatMobileView> createState() => _ChatMobileViewState();
}

class _ChatMobileViewState extends State<ChatMobileView> {
  @override
  Widget build(BuildContext context) {
    return SafeArea(
      top: false,
      child: GetBuilder<ChatController>(builder: (controller) {
        return controller.isLoading && controller.isChatMessageLoading
            ? const Scaffold(
                ...
                appBar: AppBar(
                  ...
                  title: Row(
                    children: [
                      ...
                      controller.receiverProfileImages.isEmpty &&
                              controller.receiverImage.isEmpty
                          ? Container(
                              height: 42,
                              width: 42,
                  ...
                  actions: [
                      ...
                      onPressed: () => showDialog(
                          ...
                          builder: (context) => CustomDialog(
                            dialogChild: Column(
                              ...
                              children: [
                                Text(
                                  "You're about to pay for your recipient",
                    ...
                    IconButton(
                        ...
                        icon: SvgPicture.asset(AppIcons.verifyContactField,
                        ...
                        child: ListView.separated(
                            ...
                            itemBuilder: (context, index) {
                              if (controller.currentUserId ==
                                  controller.messageList[index].fromId) {
                                if (controller
                                    .messageList[index].read.isEmpty) {
                                  controller.updateMessageReadStatus(
                                      fromId:
                                          controller.messageList[index].toId,
                                      sent: controller.messageList[index].sent);
                                }
                                return Align(
                                  alignment: Alignment.topRight,
                                  child: controller.messageList[index].type ==
                                          MessageType.text
                                      ? Container(
                                    ...
                                    children: [
                                      Flexible(
                                        child: Row(
                                          children: [
                                            /// ------------------------ receiver image
                                            controller.receiverProfileImages
                                                        .isEmpty &&
                                                    controller
                                      ...
                                      const Gap(12),
                                      controller.messageList[index].read
                                              .isNotEmpty
                                ...
                                IconButton(
                                    onPressed: () {
                                      if (controller.messageController.text.isEmpty == true &&
                                        ...
                                        AppUtils.errorToastMessage("Please type something or select an image");
                                      } else if(controller.messageController.text.trim().isEmpty){
                                        AppUtils.errorToastMessage("You can't send blank message");
                                      } else {
