...
import 'package:ilu/app/modules/message/views/inner_widgets/message_list_web_widgets.dart';
...
class MessageWebUiView extends StatelessWidget {
  final ScrollController scrollController;
  const MessageWebUiView({required this.scrollController, super.key});
        ...
        return GestureDetector(
          ...
          child: PopScope(
            ...
            child: Scaffold(
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      // todo -> screen search bar and tab bar
                      Padding(
                      ...
                      Expanded(
                        child: PageView(
                          ...
                          children: List.generate(
                              controller.activeTablist.length,
                              (index) => controller.selectedTab == 0
                                  ? const MessageListWebWidgets()
                                  : CallHistoryListWidgets(scrollController: scrollController)
                          ),
                        ),
                      )
                    ],
              ...
              bottomNavigationBar: const MainBottomNav(currentScreen: 1, isWeb: true),
            ),
          ),
        );
      }),
