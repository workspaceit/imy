...
class WithdrawRewardPointWebView extends StatelessWidget {
  const WithdrawRewardPointWebView({super.key});
      ...
      child: GetBuilder<WithdrawRewardPointController>(
        builder: (controller) => Scaffold(
          ...
          appBar: AppBar(
            ...
            backgroundColor: AppColors.colorWhite,
            leading: IconButton(
                onPressed: () => Get.offAndToNamed(Routes.PROFILE),
              ...
              child: SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Gap(32),
                    controller.selectedPayment == -1 ? const SizedBox() : CustomButton(
